...
5. cryptology 常用加解密算法工具
    1. 下载dist文件夹，即可运行
6. copyBook 包含 小说爬取和小说网站
    1. bookspider 中包含爬取脚本
    2. djangotest 可以构建小说网站
7. gzh_to_rss,分析一个公众号转成rss的聚合服务，将前一天公众号更新的文章写入到rss.xml，用于feedly订阅