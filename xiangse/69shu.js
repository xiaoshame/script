...
function get_chapter(result) {
  ...
  // let items = xml.queryWithXPath(`//ul[@id="article_list_content"]//li`);

  // for (i in items) {
  //   try {
  //     list.push({
  //       desc: items[i]
  //         .queryWithXPath(`//div[@class='newnav']/ol[@class='ellipsis_2']`)[0]
  //         .content(),
  //       cover: items[i]
  //         .queryWithXPath(`//a[@class='imgbox']/img/@data-src`)[0]
  //         .content(),
  //       bookName: items[i]
  //         .queryWithXPath(`//div[@class='newnav']/h3/a`)[0]
  //         .content(),
  //       author: items[i]
  //         .queryWithXPath(
  //           `//div[@class='newnav']/div[@class='labelbox']/label[1]`
  //         )[0]
  //         .content(),
  //       detailUrl: items[i]
  //         .queryWithXPath(`//div[@class='newnav']/h3/a[1]/@href`)[0]
  //         .content()
  //         .replace(".html", "/index.html"),
  //       cat: items[i]
  //         .queryWithXPath(
  //           `//div[@class='newnav']/div[@class='labelbox']/label[2]`
  //         )[0]
  //         .content(),
  //       status: items[i]
  //         .queryWithXPath(
  //           `//div[@class='newnav']/div[@class='labelbox']/label[3]`
  //         )[0]
  //         .content(),
  //     });
  //   } catch (e) {
