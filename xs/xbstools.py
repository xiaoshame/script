...
if __name__ == '__main__':
    xbs_to_json('D:\\workspace\\script\\xs\\data\\fanqie.xbs' , 'D:\\workspace\\script\\xs\\data\\fanqie.json')
    #json_to_xbs('D:\\workspace\\script\\xs\\data\\5.json' , 'D:\\workspace\\script\\xs\\data\\55.xbs')