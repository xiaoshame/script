...
if __name__ == '__main__':
    xbs_to_json('D:\\workspace\\script\\xs\\data\\y.xbs' , 'D:\\workspace\\script\\xs\\data\\y.json')
    # json_to_xbs('D:\\workspace\\script\\xs\\data\\1.json' , 'D:\\workspace\\script\\xs\\data\\2.xbs')